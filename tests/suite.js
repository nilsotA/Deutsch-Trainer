  ...
  const GEGEN = [
    ...
    { id: "x49",
      ...
      still: ["Ich habe die Frau Weis nicht erreicht.",
              "Weis sie und die anderen bitte darauf hin, dass das Training ausfällt."] },
    { id: "x49",
      ...
      still: ["Sprich sie direkt an oder weis sie per Mail darauf hin.",
              "Ruf sie an und weis sie auf die Änderung hin.",
              "Am besten weis sie gleich zu Beginn darauf hin.",
              "Danach weis sie in die Übung ein.",
              "Weis sie wie besprochen auf die neue Uhrzeit hin."] },
    { id: "x50",
