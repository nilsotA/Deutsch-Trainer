   ...
   eines Verbots: Jede Stelle, die ein Absolutwort tragen darf, steht hier mit Grund. */
{
  ...
  const ABS_ERLAUBT = {
    ...
    "Prüfmuster y10":     "Der Hinweis nennt die Fügung „wo immer“ („überall, wo“) selbst; „immer“ steht dort im Zitat",
...

{
  ...
  const ZIELE = [
    ...
    /* Getrennt und klein ist „dieses mal“ auch richtig: „Ich habe dir zwei Videos geschickt.
       ...
       was diese Lesart ausschließt (zusammengeschrieben, vor Komma oder „wenn“, am Satzanfang
       vor dem finiten Verb); der Rest steht in x56 auf „prüfen“ und nennt beide Lesarten. */
    { id: "x38",
      ziel: ["Jedes mal, wenn ich ins Training komme, fehlt ein Ball.", "Ich habe jedesmal nachgefragt.",
             "Dieses mal als ich kam, war keiner da.", "Manches mal fehlt mir die Ruhe."],
    ...
    { id: "x56",
      ziel: ["Hat es dieses mal geklappt?", "Nimm dieses mal drei.",
  ...
  const GEGEN = [
    ...
    { id: "a08",
      ziel: ["Mir war am ersten Tag nicht klar, um was ich mich zu kümmern hatte."],
      still: ["Die Sportler gingen in die Mensa, um was zu essen.",
              "Ihr wollt am Samstag in die Halle, um was genau zu machen?"] },
    { id: "a09",
    ...
    { id: "a09",
      ziel: ["Ihr braucht NICHT kommen, das Training fällt aus.",
             "Ihr braucht nichts mitbringen zu der Feier."],
      still: ["Ihr braucht nicht arbeiten zu gehen."] },
    { id: "a10",
    ...
    { id: "a10",
      ziel: ["Ich habe vorher keinen gefragt gehabt."],
      still: ["Wir haben keinen geeigneten gehabt.",
              "Wir haben nichts zu gewinnen gehabt."] },
    { id: "a11",
      ziel: ["Das Training fällt wegen mir aus.",
             "Wegen dir kommen wir zu spät."],
      still: ["Die Schulleitung hat des Regens wegen uns früher nach Hause geschickt."] },
    { id: "a11",
      ziel: ["Es tut mir leid, dass Sie wegen mir warten mussten.",
             "Ich habe mir wegen Dir Sorgen gemacht."],
      still: ["Des Wetters wegen ihm abzusagen, fiel schwer."] },
    { id: "a11",
      ziel: ["Ich habe mit der Trainerin wegen dir gesprochen."],
      still: ["Sie hat des schlechten Wetters wegen ihr Training abgesagt."] },
    { id: "a11",
      ziel: ["Lisa hat Montag wegen ihr Knie nicht trainiert.",
             "Die Trainerin war während der ganzen Einheit wegen mir schlecht gelaunt.",
             "Leider ist der Kapitän wegen mir ausgewechselt worden."],
      still: ["Sie hat ihrer kranken Mutter wegen ihr Praktikum verschoben."] },
    { id: "a11",
      ziel: ["Entschuldigen Sie die Verschiebung des Termins wegen mir.",
             "Innerhalb einer Woche wegen mir zweimal umplanen zu müssen, tut mir leid."],
      still: ["Von wegen ihr Knie ist kaputt – sie hat heute voll mitgespielt."] },
    { id: "t01",
    ...
    { id: "t06",
      ziel: ["Ich habe von 2019-2021 Sportwissenschaften in Köln studiert.",
             "Ich war von 2016-2019 Übungsleiterin beim TV Refrath."],
      still: ["In Gruppen von 3-4 Kindern üben wir den Pass."] },
    { id: "t06",
      ziel: [],
      still: ["Wir laufen heute Intervalle von 1000–1500 Metern."] },
    { id: "t08",
    ...
    { id: "t09",
      ziel: ["Im Zeitraum 2019-2021 wurden 120 Schülerinnen befragt.",
             "Die Studie (Weber 2018, S. 1203-1210) zeigt das.",
             "Es kamen 1200-1500 Zuschauer."],
      still: ["Die ISSN lautet 0342-2380."] },
    { id: "t10",
      ziel: ["Der Plan - so gut er war - scheiterte."],
      still: ["Die Trainingsherzfrequenz nach Karvonen: THF = HFruhe + (HFmax - HFruhe) · 0,6."] },
    { id: "t10",
      ziel: ["Aufwärmen = 10 Minuten locker laufen - danach Dehnen.",
             "HF = Herzfrequenz - sie steigt bei Belastung."],
      still: ["THF = HFruhe + (HFmax - HFruhe)",
              "HFmax = 220 - Lebensalter"] },
    { id: "t10",
      ziel: [],
      still: ["Tordifferenz = erzielte Tore - kassierte Tore",
              "Nettotrainingszeit = gesamte Zeit - alle Pausen"] },
    { id: "t10",
      ziel: [],
      still: ["erzielte Tore - kassierte Tore = Tordifferenz"] },
    { id: "t12",
    ...
    { id: "t12",
      ziel: ["Der Hausmeister fragte um 10:15 Uhr, ob die Geräte zurückgeräumt sind?",
             "Ich fragte im Kurs „Turnen“, ob ich nachschreiben darf?"],
      still: ["Sie fragte: „Weißt du, wann das Training beginnt?“",
              "Er fragte: Weißt du, wann das Training beginnt?"] },
    { id: "t12",
      ziel: ["Tom fragte den \"Neuen\", ob er mitspielt?"],
      still: [] },
    { id: "t12",
      ziel: ["Sie fragte, ob „Sportunterricht“ ein Pflichtfach ist?"],
      still: ["Er fragte mich, ob ich Zeit habe, und ich sagte: „Wann denn?“"] },
    { id: "t14",
      ziel: ["Und dann war es vorbei....",
      ...
      still: ["Name: .................... Klasse: ........",
              ...
              "1 Einleitung .................... 3"] },
    { id: "t14",
      ziel: ["Naja..... das Training war nicht so gut.",
             "Und dann ...... kam der Regen.",
             "Mal sehen, wie das Spiel ausgeht....."],
      still: ["Name: ....... Datum: ......",
              "Unterschrift: ..............."] },
    { id: "t14",
      ziel: ["Hallo zusammen,\n....wer kommt morgen zum Training?"],
      still: [] },
    { id: "t15",
      ziel: ["Wir laufen 5km.",
             "Das kostet 20Euro."],
    ...
    { id: "t17",
      ziel: ["Vielen Dank für's zuhören.",
             "Wir gehen morgen in's neu eröffnete Stadion.",
             "Ich habe mich auf's äußerste angestrengt."],
      still: ["Um's kurz zu machen: Wir haben gewonnen."] },
    { id: "t17",
      ziel: ["Wir laufen um's zugefrorene Becken."],
      still: ["Wir treffen uns am Samstag, um's nachzuholen."] },
    { id: "t20",
      ziel: ["Wir haben eine 20%-ige Steigerung gemessen.",
             "Das ist eine 100%-ig sichere Methode."],
      still: ["Wir haben eine 20%ige Steigerung gemessen.",
              "Das 95%-Konfidenzintervall liegt zwischen 12 und 18."] },
    { id: "x01",
      ziel: ["Hallo Tim Wegen dem Regen komme ich später."],
      still: [] },
    { id: "x01",
    ...
    { id: "x04",
      ziel: ["Kein Spieler darf mehr wie drei Kontakte haben.",
             "Zum Lauftreff kommen immer mehr wie 20 Leute.",
             "Keine Gruppe hat mehr wie 10 Kinder."],
      still: [] },
    { id: "x04",
    ...
    { id: "x04",
      ziel: ["Wir brauchen nicht mehr oder weniger wie sonst."],
      still: [] },
    { id: "x05",
      ziel: ["Die Kinder waren heute motivierter als wie in der letzten Stunde.",
             "Es lief besser als wie beim letzten Mal."],
      still: ["Als wie geplant alle da waren, ging es los."] },
    { id: "x05",
    ...
    { id: "x16",
      ...
      still: [] },
    { id: "x16",
      ziel: ["Die Mannschaft gewann wieder Erwarten das Finale."],
      still: [] },
    { id: "x18",
      ziel: ["Ihr seit Klasse 10, da erwarte ich mehr.",
             "Seit so gut wie am Samstag gegen Köln!"],
      still: [] },
    { id: "x18",
    ...
    { id: "x20",
      ziel: ["Ich rufe dir morgen um 9:30 Uhr an.",
             "Ich rufe dir morgen an und bringe dir den Termin in Erinnerung.",
             "Ruf mir morgen an das passt besser."],
      still: ["Ruf mir bitte an der Tür ein Taxi."] },
    { id: "x20",
    ...
    { id: "x21",
      ziel: ["Besonders interessiert mir neue Forschung zur Motorik."],
      still: [] },
    { id: "x21",
    ...
    { id: "x25",
      ziel: ["Danke für alles, viele Grüße,\nNils",
    ...
    { id: "x34",
      ziel: ["Wir widerholen die Übung."],
      still: ["Die Halle liegt in der Widerholtstraße.",
              "Die Halle liegt in der Konrad-Widerholt-Straße."] },
    { id: "x34",
      ziel: ["Die Widerholung der Übung hilft.",
             "Widerholt die Übung dreimal."],
      still: ["Das Referat behandelt Konrad Widerholt und den Dreißigjährigen Krieg."] },
    { id: "x36",
      ziel: ["Im großen und ganzen war es gut.",
             "Das war im großen und Ganzen gut.",
             "Im großen und ganzen, das Training war gut."],
      still: ["Im Großen und Ganzen war es gut."] },
    { id: "x37",
    ...
    { id: "x37",
      ziel: ["Die Schüler, die letztes mal gefehlt haben, holen den Test nach.",
             "Alle, die nächstes mal mitfahren wollen, melden sich bei mir.",
             "Wir treffen uns alle nächstes mal um acht Uhr in der Halle.",
             "Herr Otten, der letztes mal gefehlt hat, kommt heute.",
             "Den Ball, den letztes mal Jonas mitgebracht hat, brauchen wir wieder."],
      still: ["Von den drei Filmen: Schau dir den letzten mal an."] },
    { id: "x40",
    ...
    { id: "x40",
      ziel: ["Wir haben Eurytmie ausprobiert.",
             "In der Eurhytmie bewegt man sich zur Musik."],
      still: ["Wir haben Eurythmie ausprobiert.",
              "In der Eurhythmie bewegt man sich zur Musik."] },
    { id: "x41",
    ...
    { id: "x41",
      ziel: ["Hier ein paar Tips to go für die Mittagspause."],
      still: [] },
    { id: "x42",
    ...
    { id: "x42",
      ziel: ["Ich spüre gegenüber meiner Familie Haß und Wut."],
      still: [] },
    { id: "x42",
      ziel: [],
      still: ["Die Familie Nuß wohnt direkt neben der Halle."] },
    { id: "x43",
    ...
    { id: "x43",
      ziel: ["Ich besuche meine Familie Sonntag Abend und komme dann zurück.",
             "Das Montag Abend-Training fällt aus.",
             "Können wir uns am Montag\nAbend treffen?"],
      still: [] },
    { id: "x43",
      ziel: [],
      still: ["Wir besuchen die Familie Freitag morgen nach dem Training."] },
    { id: "x44",
    ...
    { id: "x44",
      ...
      still: ["Eines sehr kalten Morgens stand die ganze Klasse vor der Halle.",
              "Eines schönen, warmen Abends saßen wir draußen."] },
    { id: "x44",
      ziel: ["Wir haben des öfteren schon Abends trainiert."],
      still: ["Eines total verregneten Abends saßen wir in der Kabine.",
              "Eines etwas kühleren Abends trainierten wir draußen."] },
    { id: "x45",
    ...
    { id: "x45",
      ziel: ["Seit dem sie im dritten Semester ist, hat sie weniger Zeit.",
             "Seit dem sie den verletzten Trainer vertritt, läuft es besser.",
             "Seit dem es im vergangenen Jahr so viel geregnet hat, trainieren wir drinnen.",
             "Die Mannschaft ist motiviert, seit dem sie am vergangenen Wochenende gewonnen hat.",
             "Liebe Frau Weber,\nseit dem ich Ihren Kurs besuche, macht mir Sport mehr Spaß.",
             "Ja, seit dem ich im Verein bin, geht es mir besser.",
             "Hallo Nils, seit dem wir zusammen trainieren, bin ich schneller.",
             "Übrigens, seit dem wir die neue Halle haben, trainieren wir öfter."],
      still: ["Das Jahr 2020, seit dem wir online lehren, hat vieles verändert.",
              "Der Tag, seit dem man ihn nicht mehr gesehen hat, war ein Montag."] },
    { id: "x46",
    ...
    { id: "x46",
      ziel: ["Ich habe zwei mal ein Tor geschossen.",
             "Wir haben drei mal mäßig gespielt und dann gewonnen.",
             "Ich gehe zwei mal regelmäßig pro Woche laufen."],
      still: ["Das Feld misst zwanzig mal einundzwanzig Meter."] },
    { id: "x49",
      ...
      still: ["Leider konnte Frau Weis nicht kommen.",
              "Ich habe Herrn Weis nicht erreicht."] },
    { id: "x49",
      ziel: ["Das weis ich nicht und frage morgen beim Trainer nach.",
             "Die Trainerin weis nicht wie das geht und fängt einfach an."],
      still: [] },
    { id: "x49",
      ziel: ["Das weis sie wohl und fängt trotzdem nicht an.",
             "Ob sie kommt, weis sie nicht."],
      still: ["Ich habe die Frau Weis nicht erreicht."] },
    { id: "x49",
      ziel: ["Weis sie Bescheid oder rufst du sie an?",
             "Weis nicht ob das klappt aber ich frag mal nach.",
             "Dann weis sie wenigstens Bescheid und ruft dich an.",
             "Jetzt weis es jeder im Team und fragt nach."],
      still: [] },
    { id: "x49",
      ziel: ["Weis nicht ich frag mal nach.",
             "Weis es nicht und der Trainer ruft erst morgen zurück."],
      still: [] },
    { id: "x50",
    ...
    { id: "x50",
      ziel: ["Wir treffen uns am morgen vor dem ersten Training in der Halle.",
             "Herzlichen dank unserem Trainer für die tolle Saison.",
             "Bringt bitte genug zu Trinken und Sonnencreme mit."],
      still: ["Das am morgen stattfindende Training fällt aus."] },
    { id: "x50",
      ziel: [],
      still: ["Wir konnten vielen dank aller Spender helfen.",
              "Von allen Vereinen im Kreis zählen wir zu den besten dank der neuen Trainingsmethoden."] },
    { id: "x50",
      ziel: ["Und vielen dank Ihrem ganzen Team für die Unterstützung!",
             "Nochmals vielen dank der Trainerin für die Hilfe.",
             "Ich möchte Ihnen den besten dank unserer Mannschaft aussprechen."],
      still: ["Wir zählen zu den Besten dank der neuen Trainingsmethoden.",
              "Das gelang vielen dank der guten Vorbereitung."] },
    { id: "x50",
      ziel: ["Hallo zusammen,\nvielen dank dem ganzen Team, das Turnier war super!",
             "Liebe Grüße und vielen dank der Orga!"],
      still: ["Das gelang vielen dank eurer Unterstützung.",
              "Das gelang vielen dank der guten Vorbereitung für die Klausur.",
              "Von allen Teams landeten wir unter den besten dank unserer starken Abwehr."] },
    { id: "x53",
    ...
    { id: "x54",
      ziel: ["Zum aufwärmen, lockeres Einlaufen (5 Min.).",
             "Zum zweiten ist die Halle zu klein."],
      still: ["Es klappte erst beim zweiten.",
              "Beim schnellen, harten Training geht viel schief."] },
    { id: "x54",
      ziel: [],
    ...
    { id: "y01",
      ziel: ["Wir starten am 3.11. direkt nachdem die Herbstferien vorbei sind.",
             "Die Kinder dehnen sich z. B. direkt bevor sie sprinten."],
      still: ["Das Training beginnt um 17 Uhr. Direkt nachdem die Halle frei ist, bauen wir auf."] },
    { id: "y01",
      ziel: [],
      still: ["Mögliche Gründe für die Niederlage:\n1. vermutlich weil wir zu wenig geschlafen haben\n2. hauptsächlich weil die Abwehr unsicher war"] },
    { id: "y03",
    ...
    { id: "y03",
      ziel: ["Wir verschieben das Training, weil wir haben, wie besprochen, keine Halle.",
             "Ich komme später, weil ich muss – leider – noch arbeiten.",
             "Ich kann heute nicht, weil ich hab\nam Nachmittag noch eine Klausur."],
      still: ["Ich komme, weil ich muss.",
              "Ich komme, weil ich muss, und bleibe bis zum Schluss.",
              "Ich mag dich, weil du bist, wie du bist.",
              "Ich komme, weil ich muss\nViele Grüße",
              "Ich trainiere, weil ich will, nicht weil ich muss, und das ist gut."] },
    { id: "y03",
      ziel: [],
      still: ["Ich frage lieber nach, weil ich will, dass alles klappt, und nicht aus Misstrauen."] },
    { id: "y08",
    ...
    { id: "y10",
      ziel: ["Das ist der Schüler, wo immer zu spät kommt.",
             "Der Trainer, wo immer so rumschreit, ist heute krank."],
      still: ["Der Trainer, wo immer er auftaucht, sorgt für Stimmung."] },
    { id: "y10",
      ziel: [],
    ...
    { id: "y13",
      ...
      still: ["Wenn die Einheit am 12. Mai ausfällt, holen wir sie nach.",
              ...
              "Wenn wir z. B. Bälle brauchen, sag Bescheid."] },
    { id: "y13",
      ziel: ["Obwohl wir gut gespielt haben verloren wir am Ende mit 1 zu 3. Der Trainer war trotzdem zufrieden, weil die Abwehr stand.",
             "Falls es regnet treffen wir uns in Halle 2. Bitte bringt Hallenschuhe mit, sonst dürft ihr nicht rein.",
             "Obwohl es kalt war liefen wir zum Aufwärmen 400 m. Danach war Pause, alle waren platt."],
      still: ["Wenn wir am 3. Spieltag gewinnen, sind wir oben."] },
    { id: "y13",
      ziel: [],
      still: ["Wenn die Kinder zwischen 8 u. 10 Jahre alt sind, teilen wir sie in zwei Gruppen."] },
    { id: "y14",
    ...
    { id: "y14",
      ziel: ["Die Abgabe ist am Freitag den 13. Bitte gebt pünktlich ab.",
             "Wir sehen uns am Samstag den 14. Um 10 Uhr geht es los.",
             "Termin: Dienstag den 12.\nOrt: Sporthalle Süd"],
      still: ["Wir haben am Samstag den 3. Platz belegt."] },
  ];
  ...
  const STUFE = [
    ...
    ["x23", "Ich danke dem Trainer, dem Praktikant und der Schulleitung.", "hart"],
    ["x23", "Ich habe, wie besprochen, dem Kollege Bescheid gegeben.", "hart"],
    ["x25", "Viele Grüße, Herr Otten", "pruef"],
    ["x25", "Liebe Grüße, Frau Weber", "pruef"],
    ["x12", "Ja, Ende 2025 haben wir die Trikots neu numeriert.", "hart"],
    ["x08", "Wir machen den „Standart“-Aufwärmblock.", "hart"],
    ["x08", "Das Wort „Standart“ gibt es nicht.", "pruef"],
    ["x16", "Die Mannschaft gewann wieder\nErwarten das Finale.", "pruef"],
    ["x16", "Endlich wieder\nErwarten durften die Kinder nach der Hallensperre vor allem eines: Bewegung.", "pruef"],
    ["x36", "Wir haben im großen und ganzen Fortschritte gemacht.", "pruef"],
    ["x36", "Im großen und ganzen Stadion war kein Platz mehr frei.", "pruef"],
    ["x36", "Das hat im großen und ganzen Herr Otten organisiert.", "hart"],
    ["x36", "Das Training lief im großen und ganzen\nGut.", "hart"],
    ["x36", "Das Spiel „Kettenfangen\" hat im großen und ganzen gut geklappt, das Spiel „Feuer, Wasser, Blitz\" weniger.", "hart"],
    ["x36", "Rückblick, Saison 2025/26: Im großen und ganzen waren wir zufrieden.", "hart"],
    ["x38", "Dieses mal klappt es bestimmt.", "hart"],
    ["x38", "Jedes mal hat er seine Sachen vergessen.", "hart"],
    ["x38", "Manches mal fehlt die halbe Klasse.", "hart"],
    ["x38", "Die Übung „Kettenfangen\" hat jedesmal geklappt, die Übung „Feuer\" nicht.", "hart"],
    ["x38", "Danke, Frau Weber. Im Jahr 2025 war ich jedesmal beim Training.", "hart"],
    ["x56", "Dieses mal drei ergibt zwölf.", "pruef"],
    ["x56", "Schau dir dieses mal an.", "pruef"],
    ["x56", "Dieses mal klappt es bestimmt.", ""],
    ["x42", "Unser Motto „Gemeinsam stark\" steht fest, daß wir es „leben\" müssen.", "hart"],
    ["x50", "Es gab genug zu Essen und Trinken.", "pruef"],
    ["x50", "Im Skript steht nur wenig zu Essen und Trinken vor dem Wettkampf.", "pruef"],
    ["x50", "Bringt bitte genug zu Trinken und Sonnencreme mit.", "hart"],
    ["x57", "Das Jahr 2020, seit dem wir online lehren, hat vieles verändert.", "pruef"],
    ["x57", "Liebe Frau Weber,\nseit dem ich Ihren Kurs besuche, macht mir Sport mehr Spaß.", ""],
    ["x57", "Ja, seit dem ich im Verein bin, geht es mir besser.", ""],
    ...
    ["x50", "Der Ratgeber sagt wenig zu Essen und Getränken vor dem Wettkampf.", "pruef"],
    ["x50", "Wir treffen uns am morgen vor dem ersten Training in der Halle.", "hart"],
    ["x50", "Am morgen nach dem letzten Training war ich müde.", "hart"],
    ["x42", "Weber (1990) schreibt: „Der Begriff \"Belastung\" muß klar definiert werden.“", "pruef"],
    ["x42", "Ich spüre gegenüber meiner Familie Haß und Wut.", "hart"],
    ["x41", "Die Broschüre heißt Tips to go green und liegt in der Mensa.", "pruef"],
    ["x41", "Hier ein paar Tips to go für die Mittagspause.", "hart"],
    ["x57", "Das Spiel am 12. März, seit dem wir ungeschlagen sind, war ein Wendepunkt.", "pruef"],
    ["x57", "Das Seminar bei Frau Weber, seit dem ich mich für Sportdidaktik interessiere, war das beste im Semester.", "pruef"],
    ["x45", "Frau Weber, seit dem ich krank bin, fehle ich im Seminar.", "hart"],
    ["t06", "Das hängt von 2–3 Faktoren ab.", "pruef"],
    ["t06", "Ich habe von 2019-2021 Sportwissenschaften in Köln studiert.", "hart"],
    ["x43", "Das Montag Abend-Training fällt aus.", "hart"],
    ["x50", "Am morgen nach dem harten Training hatte ich Muskelkater.", "hart"],
    ["x50", "Am morgen in der großen Halle stattfindenden Turnier nehmen zwölf Teams teil.", "pruef"],
    ["x50", "Bringt bitte was zu Essen und Getränke mit!", "hart"],
    ["x43", "Beim Montag Abend-Training fehlen drei Spieler.", "hart"],
    ["x43", "Kein Freitag Abend-Spiel diese Saison.", "hart"],
    ["x41", "Unsere Tips to go helfen dir beim Training.", "hart"],
    ["x45", "Sehr geehrte Damen und Herren,\nseit dem ich Ihre Ausschreibung gelesen habe, interessiere ich mich für die Stelle.", "hart"],
    ["x45", "Guten Tag Frau Weber, seit dem ich letzte Woche krank war, fehlt mir die Mitschrift.", "hart"],
    ["x45", "Hallo, seit dem ich im Kurs angemeldet bin, bekomme ich keine Mails mehr.", "hart"],
    ["x45", "Stimmt, seit dem ich die Einlagen habe, tut das Knie nicht mehr weh.", "hart"],
    ["x45", "Hallo ihr Lieben,\nseit dem wir mittwochs in der großen Halle trainieren, kommen mehr Leute.", "hart"],
    ["y13", "Obwohl der Test angekündigt war fehlten fünf Schüler aus der 8 c. Ich habe sie nachschreiben lassen, aber nur zwei kamen.", "pruef"],
    ["y13", "Falls die Halle belegt ist trainieren wir in Raum 2 c. Bitte pünktlich sein, danke.", "pruef"],
    ["a11", "Die Schulleitung hat der Hitze wegen uns früher nach Hause geschickt.", "pruef"],
    ["x49", "Weis sie bitte darauf hin, dass die Halle morgen zu ist.", "pruef"],
    ["x49", "Weis sie an, sich in Zweiergruppen aufzustellen.", "pruef"],
    ["x49", "Weis es nach, bevor du es behauptest.", "pruef"],
    ["x49", "Bitte weis sie darauf hin, dass die Halle zu ist.", "pruef"],
    ["x49", "Weis sie und die anderen bitte darauf hin, dass das Training ausfällt.", "pruef"],
    ["x49", "Sprich sie direkt an oder weis sie per Mail darauf hin.", "pruef"],
    ["x49", "Ruf sie an und weis sie auf die Änderung hin.", "pruef"],
    ["x49", "Am besten weis sie gleich zu Beginn darauf hin.", "pruef"],
    ["x49", "Danach weis sie in die Übung ein.", "pruef"],
    ["x49", "Weis sie wie besprochen auf die neue Uhrzeit hin.", "pruef"],
    ["x49", "Lisa war beim Arzt und weis es jetzt und sie fällt wohl sechs Wochen aus.", "pruef"],
    ["x49", "Das weis sie wohl und fängt trotzdem nicht an.", "hart"],
    ["x49", "Ob sie kommt, weis sie nicht.", "hart"],
    ["x49", "Leider konnte Frau Weis nicht kommen.", ""],
    ["x50", "Am morgen nach dem Training hatten Lisa und ich Muskelkater.", "hart"],
    ["x50", "Ich kann am morgen in der Halle 3 stattfindenden Training nicht teilnehmen.", "pruef"],
    ["x57", "Der Kreuzbandriss war ein Einschnitt,\nseit dem ich vorsichtiger trainiere.", "pruef"],
    ["x37", "Von den drei Videos: Schau dir das erste mal an, das zweite kannst du überspringen.", "pruef"],
    ["x37", "Das erste mal war ich nervös.", "hart"],
    ["t17", "An's Referat war das beste im Seminar.", "pruef"],
